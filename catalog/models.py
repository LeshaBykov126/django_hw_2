...
class Product(models.Model):
    ...
    price_prod = models.IntegerField(verbose_name='Цена', null=True, blank=True,
    ...
    #user_boss = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True,
